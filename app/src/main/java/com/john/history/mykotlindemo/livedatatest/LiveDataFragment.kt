...
class LiveDataFragment : Fragment() {
    ...
    private var observer2=Observer<Double>{
        fragment_text2.text=it.toString()
    }
    ...
    override fun onAttach(context: Context) {
        ...
        if (context is OnFragmentInteractionListener) {
            listener = context
            if (context is LiveDataTestActivity){
                context.getLiveDataA().observe(this,observer)
                context.getLiveDataA().observe(this,observer2)
            }
        } else {
